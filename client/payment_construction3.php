...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['reject_payment'])) {
        ...
        header('Location: payment_construction3.php?orderid=' . $orderid . '&rejected=1');
        exit;
    }
    ...
    if (isset($_POST['proceed_pay'])) {
        ...
        try {
            ...
            header('Location: payment_construction3.php?orderid=' . $orderid . '&amount=' . $total_to_pay . '&success=1');
            exit;
                    ...
                    <div class="payment-detail">
                        ...
                        <div class="fee-breakdown">
                            ...
                            <div class="d-flex justify-content-between mb-1 text-info">
                                <span>Less: Construction Deposit Paid (Stage 4):</span>
