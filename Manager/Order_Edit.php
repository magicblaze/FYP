...
// 检查设计是否已确认
$is_design_confirmed = in_array(strtolower($order['ostatus'] ?? ''), ['waiting payment', 'waiting design phase payment', 'complete']);
...
$hideEditCards = in_array($status, ['waiting confirm', 'designing', 'reviewing design proposal', 'waiting client review', 'rejected', 'waiting design phase payment', 'complete']);
