                ...
                <tr>
                  ...
                  <td class="text-end" id="actions_<?= (int)$row['orderid'] ?>">
                    ...
                    <?php if (strtolower(trim($row['ostatus'] ?? '')) === 'waiting confirm'): ?>
                      <button class="btn btn-sm btn-success ms-1" onclick="updateOrder(<?= (int)$row['orderid'] ?>,'confirm', this)">Confirm</button>
                      <button class="btn btn-sm btn-danger ms-1" onclick="updateOrder(<?= (int)$row['orderid'] ?>,'reject', this)">Reject</button>
                    <?php endif; ?>
                  </td>
                </tr>
              <?php endwhile; else: ?>
