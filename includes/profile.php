...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['worker_action'])) {
        ...
        if ($wAction === 'add') {
            ...
            if ($stmt->execute()) {
                handleUpload('w_image', $wId);
                $success = "Worker information updated!";
            }
        }
    }
    // --- 通用: 个人资料更新逻辑 ---
...
// 上传函数
function handleUpload($fileInputName, $workerId) {
    global $mysqli;
    if (isset($_FILES[$fileInputName]) && $_FILES[$fileInputName]['error'] === UPLOAD_ERR_OK) {
        $ext = pathinfo($_FILES[$fileInputName]['name'], PATHINFO_EXTENSION);
        $fileName = "worker" . $workerId . ".jpg"; // 统一转为jpg或保留原后缀
        if (move_uploaded_file($_FILES[$fileInputName]['tmp_name'], "../uploads/worker/" . $fileName)) {
            $mysqli->query("UPDATE Worker SET image = '$fileName' WHERE workerid = $workerId");
        }
    }
}
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="profile-header-card mb-4">
                ...
                <div class="ms-auto">
                    <button class="btn btn-primary btn-sm px-4" data-bs-toggle="modal" data-bs-target="#editProfileModal">
            ...
            <?php if ($role === 'client'): ?>
                <div class="content-section">
                    ...
                    <div class="grey-card-box">
                        <div class="info-row"><div class="info-label">Name:</div><div class="info-val"><?= $userData['name'] ?></div></div>
                        <div class="info-row"><div class="info-label">Email:</div><div class="info-val"><?= $userData['email'] ?></div></div>
                        <div class="info-row"><div class="info-label">Phone:</div><div class="info-val"><?= $userData['tel'] ?></div></div>
                        <div class="info-row"><div class="info-label">Address:</div><div class="info-val"><?= $userData['address'] ?: 'Not set' ?></div></div>
                    </div>

                    <div class="blue-section-header mt-5"><i class="fas fa-file-pdf"></i> Floor Plan</div>
                    <div class="grey-card-box text-center">
                        <p class="text-muted small"><?= $userData['Floor_Plan'] ? "File: " . $userData['Floor_Plan'] : "No floor plan uploaded yet." ?></p>
                        <button class="btn btn-outline-primary btn-sm"><i class="fas fa-upload me-1"></i> Upload Floor Plan</button>
                    </div>

                    <div class="blue-section-header mt-5"><i class="fas fa-money-bill-wave"></i> Budget</div>
                    <div class="grey-card-box">
                        <p class="mb-0">Default budget: <strong class="text-success">HK$<?= number_format($userData['budget']) ?></strong></p>
                    </div>
                </div>
                    ...
                    ?>
                        <div class="worker-card">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-primary small mt-1"><i class="fas fa-certificate me-1"></i><?= $w['certificate'] ?></div>
                            </div>
        ...
        <!-- 右侧侧边栏 (Contact & Services) -->
        <div class="col-lg-4" style="margin-top: 20px;">
            <div class="sidebar-box">
                <div class="sidebar-title">Contact</div>
                <span class="sidebar-label">Email Address</span>
            ...
            <div class="sidebar-box">
                ...
                <ul class="list-unstyled mb-0 small text-muted">
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Interior design</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Space planning</li>
        ...
        <form method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tel" class="form-control" value="<?= $userData['tel'] ?>">
                </div>
                <?php if ($role === 'client'): ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold">Budget (HKD)</label>
                        <input type="number" name="budget" class="form-control" value="<?= $userData['budget'] ?>">
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="modal-dialog">
        <form method="POST" enctype="multipart/form-data" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label small fw-bold text-primary">Worker Photo</label>
                    <input type="file" name="w_image" class="form-control" accept="image/*">
                </div>
            </div>
            <div class="modal-footer">
...
function openEditWorker(w) {
    document.getElementById('wModalTitle').innerText = 'Edit Worker Details';
