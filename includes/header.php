...
// compute base URL pointing to application root (one level up from script dir)
...
$baseUrl = $scheme . '://' . $host . ($appRoot === '' ? '' : $appRoot);
?>
    ...
    <nav>
      <ul class="nav align-items-center gap-2">
        ...
        <?php else: ?>
          ...
          <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/furniture_dashboard.php">Furniture</a></li>
        <?php endif; ?>
      </ul>
    </nav>
  </div>
